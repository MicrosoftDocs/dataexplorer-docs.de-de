...
> [!TIP]
> Bei der Erstellung eines eigenen Workflows empfehlen wir, den Code idempotent zu gestalten. Verwenden Sie beispielsweise [`.create-merge table`](kusto/management/create-merge-table-command.md) anstelle von [`.create table`](kusto/management/create-table-command.md) und die Funktion [`.create-or-alter`](kusto/management/create-alter-function.md) anstelle der Funktion [`.create`](kusto/management/create-function.md).
