---
title: series_fit_poly_lf ()-Azure Daten-Explorer
description: In diesem Artikel wird die benutzerdefinierte Funktion "series_fit_poly_lf ()" in Azure Daten-Explorer beschrieben.
author: orspod
ms.author: orspodek
...
:::image type="content" source="images/series-fit-poly-lf/usage-example.png" alt-text="Diagramm mit der 5.-Reihenfolge Polynoms an reguläre Zeitreihen anpassen" border="false":::
...
1. Testen von unregelmäßigen Zeitreihen (nicht gleichmäßig verteilt)
    ...
    :::image type="content" source="images/series-fit-poly-lf/irregular-time-series.png" alt-text="Diagramm mit der 8. Reihenfolge Polynoms, die an eine unregelmäßige Zeit Reihe angepasst ist" border="false":::
...
1. 5.-Reihenfolge Polynoms mit Rauschen für x & y-Achsen
    ...
    :::image type="content" source="images/series-fit-poly-lf/fifth-order-noise.png" alt-text="Diagramm der Anpassung der 5.-Reihenfolge Polynoms mit Rauschen für x & y-Achsen":::
       
    :::image type="content" source="images/series-fit-poly-lf/fifth-order-noise-table.png" alt-text="Koeffizienten der Eignung der 5.-Reihenfolge Polynoms mit Rauschen" border="false":::
