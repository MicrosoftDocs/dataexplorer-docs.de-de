...
ms.locfileid: "91452872"
---
# <a name="geo_distance_point_to_line"></a>geo_distance_point_to_line()

Berechnet den kürzesten Abstand zwischen einer Koordinate und einer Linie oder mehreren Zeilen in der Erde.
...
:::image type="content" source="images/geo-distance-point-to-line-function/us-south-coast-storm-events.png" alt-text="Abstand zwischen North Las Vegas-Flughafen und Straße":::
...
NY Taxi Pickups. Pickups werden nach einem maximalen Abstand von 0,1 Meter von der definierten mehrzeiligen Menge gefiltert.

:::image type="content" source="images/geo-distance-point-to-line-function/madison-ave-road.png" alt-text="Abstand zwischen North Las Vegas-Flughafen und Straße":::
